...
namespace miniStudio
{
    [ToolboxItem(true)]
    [Serializable]
    public partial class aaa : UserControl, ICustomTypeDescriptor, ISerializable 
    {
        public aaa():base()
        {
            InitializeComponent();
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            //info.AddValue("Colnumber",this.Colnumber);
        ...
        public aaa(SerializationInfo info, StreamingContext context) 
        {
            ...
            //this.Colnumber = (Int32)info.GetValue("Colnumber", typeof(Int32));
            // this.Rownumber = (Int32)info.GetValue("Rownumber", typeof(Int32));
        } 
        #endregion
    }
}
